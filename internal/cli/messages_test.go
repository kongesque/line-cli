...
func TestMessageArgumentsValidateBeforeSessionAccess(t *testing.T) {
	for _, args := range [][]string{
		...
		{"messages", "u-peer", "--limit", "0"}, {"messages", "u-peer", "--limit", "101"},
		{"send", "u-peer"}, {"send", "u-peer", "--text", ""},
		{"send", "u-peer", "--text", "hello", "--stdin"},
		{"send", "../bad", "--text", "hello"},
		{"send", "u-peer", "--text", "hello", "extra"},
	} {
...
func TestSendStdinPreservesMultilineTextAndJSONOutput(t *testing.T) {
	...
	if err := a.Run([]string{"send", "u-peer", "--stdin", "--json"}); err != nil {
		t.Fatal(err)
	}
...
func TestHistoryPartialFailureStillReturnsStructuredJSON(t *testing.T) {
	...
	a.Manager.NewClient = func(string) session.API { return f }
	err := a.Run([]string{"messages", "u-peer", "--json"})
	if err == nil {
...
func TestSendStdinHasBoundedSize(t *testing.T) {
	...
	if err := a.Run([]string{"send", "u-peer", "--stdin"}); err == nil {
